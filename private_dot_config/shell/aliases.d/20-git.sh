...
alias gundoh='git reset --hard HEAD~1'   # Undo last commit, discard all changes
alias gundom='git reset --mixed HEAD~1'  # Undo last commit, keep changes unstaged (default)
